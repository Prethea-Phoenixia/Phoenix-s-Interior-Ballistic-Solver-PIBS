...
class LocDropdown(LocalizableWidget, Descriptive):
    def __init__(
        ...
        parent,
        font=None,
        str_obj_dict: dict[str, object] = None,
        loc_func=None,
        all_localized=None,
        desc_label_key: str = "",
        tooltip_loc_key: str = "",
...
class LocalizedFrame(Frame):
    def __init__(
        self, *args, font=None, localization_dict: dict[str, dict[str, str]], menubar, default_lang: str, **kwargs
    ):
