...
class Recoilless(BaseGun):
    ...
    def ode_t(
        ...
        deta = self.C_a * self.s_j_bar * p_bar * tau**-0.5
        dtau = ((1 - tau) * (dpsi * dz) - 2 * v_bar * dv_bar - self.theta * tau * deta) / (psi - eta)
    ...
    def integrate(
        ...
        **_,
        ...
        if dom == DOMAIN_TIME:
            ...
            t_bar_j = 0.5 * t_bar_i
            z_j, l_bar_j, v_bar_j, eta_j, tau_j = rkf(self.ode_t, (self.z_0, 0, 0, 0, 1), 0, t_bar_j, rel_tol=tol)[1]
