...
class InteriorBallisticsFrame(LocalizedFrame):
    ...
    def update_table(self):
        ...
        table_data = self.format_table()
        loc_table_data = table_data  # dot_aligned(table_data, units=None, use_sn=None)  # units=units, use_sn=use_sn, strip_ws=False)
    ...
    def use_theme(self):
        ...
        # todo: this was broken due to recent work on logging. fix it.
